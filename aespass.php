            ...
            <div class="container" id=divEncryptfile>
                <div class="contens">
                    ...
                    <div class="pass-content">
                        <form class="pass-form">
                            <div class="input-div-one">
                                <div class="input-field">
                                    <input class="form-control" id="encpassword" type="password" name="password" required spellcheck="false" size=30 onkeyup=javascript:encvalidate(); value=''>
                        ...
                        <div class="but"><button class="btn" type="button" id="encryptbutton" disabled>Encrypt File</button></div>
                    ...
                    <div class="top-header">
                        ...
                        <div class="divTable">
                            <form class="pass-form">
                                <div class="input-div-one">
                                    <div class="input-field">
                                        <input id="decpassword" type=password name="password" required spellcheck="false" size=30 onkeyup=javascript:decvalidate(); value=''>
                        ...
                        <div>
                            <div class="but"><button type="button" class="btn" id="decryptbutton" disabled>Decrypt File</button></div>
        ...
        <script>
            ...
            document.querySelector("#encryptbutton").addEventListener("click", () => {
                ...
                if (password == null || password === "") {
                    spnEncstatus.classList.add("redspan");
		            spnEncstatus.innerHTML='<p>Mohon masukan Password.</p>';
                    return;
                }
            ...
            document.querySelector("#decryptbutton").addEventListener("click", () => {
                ...
                if (password == null || password === "") {
                    spnDecstatus.classList.add("redspan");
		            spnDecstatus.innerHTML='<p>Password salah.</p>';
                    return;
                }
